...
//        System.exit(0);
    ...
    companion object {
        ...
        fun getInstance(): ActivityHelper {
            check(Companion::instance.isInitialized) { "ActivityHelper should be initialized first, please check you are already LocalePlugin.init(...) in application"  }
            return instance
        }
        ...
        internal fun init(interfaceUpdateWay: Int): ActivityHelper {
            check(!Companion::instance.isInitialized) { "ActivityHelper is already initialized" }
