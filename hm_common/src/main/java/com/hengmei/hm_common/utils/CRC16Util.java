...
public class CRC16Util {
    ...
    public static byte[] calcCrc16(byte[] data) {
        ...
        int countNub =  calcCrc16(data, 0, data.length);
        byte[] hexByte = new byte[data.length + 2];
         ...
         * 取余数 跟 被除数
         * */
        byte a1 = (byte) (countNub/256);
        byte a2 = (byte) (countNub%256);

        hexByte[data.length] = a2;
        hexByte[data.length+1] = a1;
        return hexByte;
    }
