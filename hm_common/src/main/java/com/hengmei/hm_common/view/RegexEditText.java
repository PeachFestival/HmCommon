package com.hengmei.hm_common.view;
...
public class RegexEditText extends AppCompatEditText implements InputFilter {
    ...
    public static final String PutDouble = "[-+]?[0-9]*\\.?[0-9]*";
    /** 设置包含小数点，小数点保留一位*/
    public static final String PutDoubleOne = "[+]?[0-9]*\\.?[0-9]{0,1}";
            ...
            if (array.hasValue(R.styleable.RegexEditText_regexType)) {
                ...
                switch (regexType) {
                    ...
                    case 0x06:
                        ...
                        break;
                    case 0x07:
                        setInputRegex(PutDouble);
                        break;
                    case 0x08:
                        setInputRegex(PutDoubleOne);
                        break;
                    default:
                        break;
                }
