...
public class Wifi implements IWifi {
    ...
    public static IWifi create(ScanResult result, List<WifiConfiguration> configurations, String connectedSSID, int ipAddress) {
        ...
        wifi.bssid = result.BSSID != null ? result.BSSID : "";
        ...
        } else if (wifi.capabilities.toUpperCase().contains("WPA3")) {
            wifi.encryption = "WPA3";
        } else if (wifi.capabilities.toUpperCase().contains("WEP")) {
            wifi.encryption = "WEP";
        } else {
    ...
    public boolean equals(Object obj) {
        ...
        return ((Wifi) obj).SSID != null && ((Wifi) obj).SSID.equals(this.SSID);
    }
